...
public class Hawaii extends Attractie implements gevaarlijkVoorHartklachten{
	String naam = "de Hawaii";
	static double prijsPerEenheid = 2.9;
	...
	public void draaien() {
		System.out.println(
				"\nHEEEEEERE WE GOOOO!!!! \n~~~~~~~~ 5 minuten later ~~~~~~~~ \nHo! Blijf recht lopen, ik snap dat je duizelig bent. Ga maar even lekker zitten.\n");
	}
