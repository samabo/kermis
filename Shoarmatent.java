...
public class Shoarmatent extends Voedselkraam implements gevaarlijkVoorHartklachten{
	String naam = "de shoarmatent";
	String product = "shoarma";
	double prijsPerEenheid = 5.15;
